/*
  ...
  - Added the required column `workspaceEmoji` to the `Workspace` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "workspaceEmoji" TEXT NOT NULL;
